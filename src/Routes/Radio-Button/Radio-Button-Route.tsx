...
import MDRadioButtonList, { RadioListItem } from '../../Control-Library/Radio-Button/Radio-Button-List';
import MDText, { Alignment } from '../../Control-Library/Text/Text';

const RadioButtonRoute: FunctionComponent = () => {
    const [Checked, setChecked] = useState(true);

    const ItemChenge = (Checked: boolean, Caption: string, Id?: number) => {
    }

    const RadioList: RadioListItem[] = [
    ...
    return (<MDBox Bordered Rounded DefaultMargin ContentDirection={Direction.Vertical}>
        <MDPageTitle Title="Radio Button List" Icon={<MDIcon IconType={IconType.RadioButton} />} />
        ...
        <MDBox ContentDirection={Direction.Vertical} DefaultMargin DefaultPadding>
            ...
            <MDBox Bordered Rounded
                ...
                <MDBox WholeWidth
                    ...
                    <MDRadioButtonList List={RadioList} OnChange={ItemChenge} />
                </MDBox>
            </MDBox>
        </MDBox>
        <MDBox ContentDirection={Direction.Vertical} DefaultMargin DefaultPadding>
        ...
        <MDBox DefaultMargin DefaultPadding>
            ...
            <MDCodeBlock code=""></MDCodeBlock>
        </MDBox>
    </MDBox>
    )
}

export default RadioButtonRoute;